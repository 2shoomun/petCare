  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        contentPadding: EdgeInsets.symmetric(vertical: 30, horizontal: 40), // Increase padding
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20.0), // Make the dialog rounded
        ),
                ...
                style: ButtonStyle(
                  ...
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20.0), // Make the button rounded
                    ),
                  ),
                ),
                onPressed: () {
              ...
              Center(
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()||PetCount.numberOfRegisteredPets>0) {
