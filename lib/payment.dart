...
import 'package:pet_care/paymentSuccessAnimation.dart';
import 'package:pet_care/services_registration.dart';
        ...
        color: Theme.of(context).primaryColor,
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LottieAnimationPayment()),
                );
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (context) =>
                              ServiceProviderRegistrationApp()),
                      (route) => false, // Remove all routes from the stack
                    );
                  },
                ),
