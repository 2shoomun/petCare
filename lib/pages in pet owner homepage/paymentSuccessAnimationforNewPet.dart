...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: myTheme,
      home: LottieAnimationPaymentPet(),
    );
  }
}

class LottieAnimationPaymentPet extends StatefulWidget {
  @override
  _LottieAnimationPageState createState() => _LottieAnimationPageState();
}

class _LottieAnimationPageState extends State<LottieAnimationPaymentPet> {
  bool showText = false;
