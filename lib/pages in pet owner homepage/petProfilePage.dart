...
import 'dart:io';
import 'petOwnerProfilePage.dart';
import 'package:image_picker/image_picker.dart';
...
class ProfileAppPet extends StatelessWidget {
  ...
  final List<UserProfile> userProfiles; // Pass the list of user profiles
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: myTheme,
      home: ProfilePagePet(selectedUserProfile, userProfiles),
    );
  }
}

class ProfilePagePet extends StatefulWidget {
  final UserProfile user; // Pass the selected user's details
  final List<UserProfile> userProfiles; // Pass the list of user profiles

  ProfilePagePet(this.user,
      this.userProfiles); // Constructor to receive user details and userProfiles

  @override
  _ProfilePagePetState createState() => _ProfilePagePetState();
}

class _ProfilePagePetState extends State<ProfilePagePet> {
  ...
  void _removePet(UserProfile user) {
  ...
  Widget _buildTextField(String label, TextEditingController controller) {
    return TextField(
      ...
      style: TextStyle(
          color: _isEditing ? null : Colors.grey.shade800, fontSize: 18.0),
    );
  }
