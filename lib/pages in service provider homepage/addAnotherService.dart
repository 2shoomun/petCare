...
import 'package:pet_care/pages in pet owner homepage/paymentAddAnotherPet.dart';
import 'package:pet_care/main.dart';
// import 'package:location_picker_flutter_map/location_picker_flutter_map.dart';
// import 'package:latlong2/latlong.dart';

void main() {
  runApp(AddAnotherServiceApp());
}
...
class AddAnotherServiceApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AddAnotherServicePage(),
    );
  }
}

class AddAnotherServicePage extends StatefulWidget {
  @override
  _AddAnotherServicePageState createState() =>
      _AddAnotherServicePageState();
}

class _AddAnotherServicePageState
    extends State<AddAnotherServicePage> {
