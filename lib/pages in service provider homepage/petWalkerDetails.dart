...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: myTheme,
      home: ServiceDetailPetWalker(),
    );
  }
}

class ServiceDetailPetWalker extends StatefulWidget {
  @override
  _ServiceDetailPetWalkerState createState() => _ServiceDetailPetWalkerState();
}

class _ServiceDetailPetWalkerState extends State<ServiceDetailPetWalker> {
