...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: myTheme,
      home: ServiceDetailPetSitter(),
    );
  }
}

class ServiceDetailPetSitter extends StatefulWidget {
  @override
  _ServiceDetailPetSitterState createState() => _ServiceDetailPetSitterState();
}

class _ServiceDetailPetSitterState extends State<ServiceDetailPetSitter> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String serviceType = 'Pet Sitter';
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(
                initialValue: numberOfPets.toString(),
                enabled: isEditing,
                decoration: InputDecoration(
                  labelText: 'Number of Pets in the Household',
                  labelStyle: TextStyle(
                    color: Colors.grey.shade800,
                    fontSize: 22.0,
                    fontWeight: FontWeight.bold,
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    return 'Number of Pets is required';
                  }
                  return null;
                },
                onSaved: (value) {
                  numberOfPets = int.parse(value!);
                },
              ),
